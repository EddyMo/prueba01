...
col_bajaRelevancia <- c("NRO_CODEUDORES","CANTIDAD_HIJOS") # ,"ESTADO_CIVIL"
col_colinealidad <- c("log_EDAD","log_MONTO_OPERACION","log_INGRESOS_GASTOS",
                      "PASIVO_ACTIVO", "MONTO_OPERACION", "COD_PROFESION") #, "EDAD"
# col_capacidad <- c("NIVEL_EDUCACION","CARGO")
...
scorecard_ply(auxDsTest, card, only_total_score=FALSE) %>% as.data.frame()
